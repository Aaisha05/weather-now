...
const WeatherApp=()=>{
    ...
    let api_key="96f381338bc43537a9e598aa7aa70cb3";
    ...
    const search=async()=>{
        ...
        temp_min[0].innerHTML = data.main.temp_min+" c";
        temp_max[0].innerHTML = data.main.temp_max+" c";
        ...
        <div className='container'>
            ...
            <div className="data-container">
                ...
                <div className="element">
                   ...
                   <div className="data">
                       <div className="temp_min">20 c</div>
               ...
               <div className="element">
                   ...
                   <div className="data">
                       <div className="temp_max">26 c</div>
